...
load 'cls://org.arl.unet.phy.RangingShellExt',          Services.RANGING
...
load 'cls://org.arl.unet.mac.CSMAShellExt',                 { agentsForService(Services.MAC).type == 'org.arl.unet.mac.CSMA' }
load 'cls://org.arl.unet.transport.SWTransportShellExt',    { agentsForService(Services.TRANSPORT).type == 'org.arl.unet.transport.SWTransport' }

def fshrcScript = new File(home, 'scripts/atnode.groovy')
